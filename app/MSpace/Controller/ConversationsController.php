...
use MSpace\Model\Notifications;
use MSpace\Model\Users;
use MSpace\Model\UserSettings;
...
class ConversationsController extends ControllerBase {
    ...
    public function list_allAction() {
		...
		foreach($currentUser->getConversations(['order' => 'MSpace\\Model\\Conversations.modified desc']) as $conversation) {
    ...
    private function getCommonConversation(Users $receiver,Users $sender){
		$statement = $this->db->prepare(
			...
			FROM MSpace.conversations_users
			WHERE user_id IN (?,?)
